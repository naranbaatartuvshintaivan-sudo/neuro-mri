...
export function TrustBar() {
  return (
    <section className="relative border-y border-line bg-surface">
      <div className="atmo-dots absolute inset-0 opacity-[0.4] [mask-image:linear-gradient(to_bottom,transparent,black,transparent)]" />
        ...
        {STATS.map((s, i) => (
          <Reveal key={s.label} delay={i * 0.1}>
            <div className="flex flex-col gap-2 px-6 py-10 sm:px-8 lg:py-12">
              <span className="font-mono text-4xl font-semibold tracking-tight text-primary sm:text-5xl">
                {s.value}
              </span>
